...
1. Log in to the [Azure portal](https://manage.windowsazure.cn) and click **New** in the lower-left corner.
...
2. Open your web app's blade in the [Azure portal](https://manage.windowsazure.cn).
...
[webmatrixwebsite]: /documentation/articles/web-sites-dotnet-using-webmatrix.md
[vswebsite]: /documentation/articles/web-sites-dotnet-get-started.md
